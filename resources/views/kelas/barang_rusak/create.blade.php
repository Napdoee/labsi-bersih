<x-app-layout>
    <x-slot name="header">
        <h1 class="page-title">Lapor Barang Rusak di Lab</h1>
        <p class="page-subtitle">Laporkan kerusakan inventaris laboratorium agar segera mendapatkan penanganan teknis.</p>
    </x-slot>
        ...
        <form action="{{ route('kelas.barang-rusak.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="no-jadwal-alert" style="display: none; background-color: #FFFBEB; border-left: 4px solid #F59E0B; padding: 1rem; border-radius: 4px; margin-bottom: 1.5rem;">
                <div style="display: flex; gap: 0.75rem;">
                    ...
                    <div>
                        <p style="font-size: 0.9rem; font-weight: 600; color: #92400E;">Tidak ada jadwal lab hari ini.</p>
                        <p style="font-size: 0.85rem; color: #B45309; margin-top: 0.25rem;">Laporan barang rusak hanya dapat dibuat pada hari yang memiliki jadwal Anda.</p>
                    </div>
                </div>
            </div>
            ...
            <div id="form-fields">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_barang" name="nama_barang" required class="form-control" placeholder="Misal: Mouse, Keyboard, Kursi, Monitor...">
                </div>

                {{-- Nomor Meja / PC --}}
                <div class="form-group">
                    <label class="form-label" for="no_meja_pc">Nomor Meja / PC (Opsional)</label>
                    <input type="text" id="no_meja_pc" name="no_meja_pc" class="form-control" placeholder="Misal: PC-05, Meja Belakang...">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="drop-zone" style="border: 2px dashed #CBD5E1; border-radius: 16px; padding: 2.5rem; text-align: center; cursor: pointer; transition: all 0.2s ease;">
                        ...
                        <input id="foto_bukti" name="foto_bukti" type="file" style="display: none;" accept="image/*" required>
                    </div>
                ...
                {{-- Deskripsi --}}
                <div class="form-group">
                    <label class="form-label" for="deskripsi_kerusakan">Detail Kerusakan</label>
                    <textarea id="deskripsi_kerusakan" name="deskripsi_kerusakan" rows="3" required class="form-control" placeholder="Jelaskan bagian mana yang rusak atau kondisi barang tersebut..."></textarea>
                </div>
            </div>
            ...
            fetch('{{ route("kelas.barang-rusak.ruangan-hari-ini") }}')
                ...
                .then(result => {
                    ...
                    if (result.success && result.data.length > 0) {
                        ...
                        ruanganSelect.innerHTML = '<option value="">-- Tidak ada jadwal lab hari ini --</option>';

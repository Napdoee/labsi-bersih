...
<aside class="hidden lg:flex flex-col w-[280px] h-screen border-r border-gray-100 bg-white shadow-[2px_0_8px_-4px_rgba(0,0,0,0.05)] z-20">
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1.5 custom-scrollbar">
        ...
        <div class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-4 mt-8 px-4">Pengaturan</div>

        <a href="{{ route('profile.edit') }}" class="{{ request()->routeIs('profile.edit') ? $activeClasses : $inactiveClasses }}">
            <svg class="w-5 h-5 {{ request()->routeIs('profile.edit') ? 'text-indigo-600' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
